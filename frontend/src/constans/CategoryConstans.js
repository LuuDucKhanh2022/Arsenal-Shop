...
export const STOP_BUSINESS_CATEGORY_REQUEST = "STOP_BUSINESS_CATEGORY_REQUEST";
export const STOP_BUSINESS_CATEGORY_SUCCESS = "STOP_BUSINESS_CATEGORY_SUCCESS";
export const STOP_BUSINESS_CATEGORY_RESET = "STOP_BUSINESS_CATEGORY_RESET";
export const STOP_BUSINESS_CATEGORY_FAIL = "STOP_BUSINESS_CATEGORY_FAIL";
