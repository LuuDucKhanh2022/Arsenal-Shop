...
export const STOP_BUSINESS_REQUEST = "STOP_BUSINESS_REQUEST";
export const STOP_BUSINESS_SUCCESS = "STOP_BUSINESS_SUCCESS";
export const STOP_BUSINESS_RESET = "STOP_BUSINESS_RESET";
export const STOP_BUSINESS_FAIL = "STOP_BUSINESS_FAIL";
