...
export const getAllUsers = () => async (dispatch) => {
  try {
    ...
    const { data } = await axios.get(`${baseURL}/api/v2/admin/users`);
...
export const resetPassword = (token, passwords) => async (dispatch) => {
  try {
    ...
    const { data } = await axios.put(
      `${baseURL}/api/v2/password/reset/${token}`,
      passwords,
      config
    );
...
export const deleteUser = (id) => async (dispatch) => {
  try {
    ...
    const { data } = await axios.delete(`${baseURL}/api/v2/admin/user/${id}`);
...
export const getUserDetails = (id) => async (dispatch) => {
  try {
    ...
    const { data } = await axios.get(`${baseURL}/api/v2/admin/user/${id}`);
